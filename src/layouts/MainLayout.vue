<template>
  <q-layout view="hHh Lpr fff">
    <q-header class="q-py-sm bg-indigo-7" :style="'border-bottom: 2px solid;'">
      <q-toolbar>
        <span :style="'font-size: 35px;color:'" class="my-font text-h6 q-mr-md">
          <img @click="$router.replace('/home')" style="cursor: pointer;width: 120px;height: 60px;padding-top: 10px" src="https://healthstandards.org/files/EQual-Logo-RGB-FINAL_Primary2-1.png">
        </span>
        <q-space></q-space>
        ...
        <q-btn flat class="bg-indigo-7" v-if="Object.keys(user).length > 0">
          <q-avatar>
            ...
            <img src="https://docsach24.com/no-avatar.png" v-else>
          </q-avatar>
          <q-item>
            <q-item-section>
