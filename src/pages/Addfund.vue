<template>
  <div class="q-pa-md row items-start q-gutter-md">
    <q-card push bordered class="my-card">
      <q-card-section>
        <q-select style="margin-top: 10px" outlined v-model="amount" :options="amount_option" label="Choose the amount"/>
        ...
        <div v-if="payment === 'Credit or debit card' ">
          <img style="margin-top: 20px; margin-bottom: 10px; width: 50px; height: 30px;" src="https://www.scdn.co/bundles/spotifycheckout/svg/cards/visa.svg" alt="">
          <img style="margin-top: 20px; margin-bottom: 10px; width: 50px; height: 30px;" src="https://www.scdn.co/bundles/spotifycheckout/svg/cards/mastercard.svg" alt="">
          <p style="margin: 2px">Card Number</p>
          <q-input outlined v-model="text" />
          <p style="margin-top: 10px">Expiry date</p>
          <div style="display: flex">
            <q-select style="width: 190px; margin-right: 20px" outlined v-model="month" :options="month_option" label="Month" />
        ...
        <div v-if="payment === 'Paypal' ">
          <img style="margin-top: 20px; margin-bottom: 10px; width: 65px; height: 20px;" src="https://www.scdn.co/bundles/spotifycheckout/svg/providers/paypal.svg" alt="">
...
export default {
  ...
  methods: {
    addFund(){
      axios.post(process.env.API_URL + '/addfund/',{
