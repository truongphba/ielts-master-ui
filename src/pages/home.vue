  ...
  <div>
    <div class="q-banner text-center relative-position">
      <div class="q-pa-md q-gutter-sm absolute-center">
        <q-btn v-if="Object.keys(user).length > 0 && !user.is_lecture && !isExam" color="red" @click="openModal()"
               label="Get Exam"
               size="xl"/>
    ...
    <div class="q-pa-md row items-start q-gutter-md">
      <div style="font-size: 20px; margin: 40px auto; text-align: center">
        <strong>Prepare for your English exam</strong>
        <p style="padding: 0 350px">We have lots of exam preparation to help you get ready for your exam. These include
          free materials such
          as sample papers, vocabulary lists and worksheets. Search for your exam and find the preparation materials
          you need.</p>
      </div>
      <div style="display: flex; margin-top: 50px; letter-spacing: 1px">
        <div style="margin-left: 200px; width: 500px">
          <img src="https://www.cambridgeenglish.org/Images/ap1%20%281%29.jpg" alt="">
        </div>
        <div style="margin-top: 40px ; margin-left: 320px; width: 500px; font-size: 20px">
          <p><strong>Your path to learning English, step by step</strong></p>
          <p>
            Our English Qualifications are in-depth exams that make learning English enjoyable, effective and
            rewarding. Our unique approach encourages continuous progression with a clear path to improve language
            skills. We have qualifications for schools, general and higher education, and business.
          </p>
        </div>
      </div>
      ...
      <div style="display: flex; margin-top: 50px; letter-spacing: 1px">
        <div style="margin-top: 40px ; margin-left: 320px; width: 500px; font-size: 20px">
          <p><strong>Online English testing, simplified</strong></p>
          <p>
            Linguaskill is a quick and convenient online test to help higher education institutions and employers check
            the English levels of individuals and groups of candidates. It combines the latest technology with the
            reliability and quality you expect.
          </p>
        </div>
        <div style="margin-left: 200px; width: 500px">
          <img src="https://www.cambridgeenglish.org/Images/ap3%20copy.jpg" alt="">
        </div>
      </div>

      <div style="font-size: 20px; margin: 40px auto; text-align: center">
        <p style="padding: 0 450px">Please note: <i>Our test is not a Ielts exam and the test scores
          and levels are very approximate. Your score on this test cannot be used as proof of a formal language
          qualification.</i></p>
      </div>

    </div>

    <div class="text-h5 text-weight-bold q-px-md">Top Lecturer</div>
