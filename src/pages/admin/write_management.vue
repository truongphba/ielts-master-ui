  ...
  <q-page class="q-pa-sm">
      ...
      >
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <q-td :style="{width: '1000px', whiteSpace: 'normal'}" key="content" :props="props"
    ...
    >
      <q-card style="width: 700px; max-width: 80vw;">
        <q-card-section>
          <div class="text-h6">Edit Writing</div>
        </q-card-section>
    ...
    <!--    &lt;!&ndash;        writing answer page&ndash;&gt;-->
    <!--    <q-dialog-->
    <!--      v-model="dialog"-->
    <!--      persistent-->
    ...
    <!--        &lt;!&ndash;    writing answer table&ndash;&gt;-->
    <!--        <q-page class="q-pa-sm">-->
    <!--          <q-card>-->
    <!--            <q-table-->
