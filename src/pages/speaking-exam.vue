<template>
  ...
  <div v-else class="row items-start q-gutter-md q-pa-lg" style="padding-left: 20%;padding-right: 20%">
    <q-card class="my-card col-md-3" style="height: 500px">
      <img style="height: 350px;overflow: hidden" :src="lecture.avatar" v-if="lecture.avatar">
      <img style="height: 350px;overflow: hidden" v-else src="https://r9b7u4m2.stackpathcdn.com/prod/sites/eXfkOOiYH-uoddxClSi52viuasTF1mJ8olZ0u-tOtfFqK66gZCc90Ly_Uoc0VmR1eULwQ0uGf2JhPt4yPTts8A/themes/base/assets/images/avatar-1.png">
      <q-card-section>
        <q-rating
          :value="lecture.votes"
          size="2em"
    ...
    <q-card class="my-card col-md-8">
      <q-img height="500px" src="https://cdn.quasar.dev/img/parallax2.jpg">
      </q-img>
    ...
    <q-dialog v-model="pre" persistent full-width full-height>
      <q-card class="bg-teal">
        <q-card-section class="row"  style="margin: 150px">
          <h3 style="text-align: center;text-transform: uppercase;width: 100%;color: white">Ready for the speaking
            exam.</h3>
          <div class="countdown absolute-center pre-countdown"
               style="color: white;font-size: 55pt;margin-top: 200px">
            <vue-countdown-timer
